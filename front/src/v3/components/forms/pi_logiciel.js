export default function update_pi_logiciel(form, model) {
  ...
  fields.logiciel_compose_details.visible =
    model.originalite.startsWith("logiciel composé");
  fields.logiciel_derive_details.visible =
    model.originalite.startsWith("logiciel dérivé");
