...
from typing import TYPE_CHECKING, Any, Collection, Dict, List, Optional, Text, \
    Type
...
_REGISTRY: Dict[Text, Type[Demande]] = {
    "rh": DemandeRH,
...
def demande_factory(
    type: Text, demandeur: Profile, data: Dict, **args: Dict
) -> Demande:
